...
**0.4.4-test is an integrated test release, not a production security appliance.**
...
**0.4.4-test includes the editors, history explorer, live family controller, notification health checks, and optional privacy packs.
...
older 0.3.0-test interface uses different labels; upgrade to 0.4.4-test for the
